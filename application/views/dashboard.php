...
<div class="row">
    <div class="alert alert-success col-12" role="alert">
        <p>Dans cette rubrique, vous trouverez l'ensemble des informations concernant l'établissement. Si vous avez renseigné un lien pour le menu. Vous devez avoir un QRcode et un lien permettant d'y accéder.</p>
    </div>
</div>
</section>
